//
//  AWMozaicLayoutSectionGeometry.swift
...
/// The `AWMozaicLayoutSectionGeometry` defines the class that represent the geometry of collection view layout
class AWMozaicLayoutSectionGeometry {
    
    /// Layout content height (dynamically calculated)
    private(set) var contentHeight: CGFloat = 0
    
    /// Sections geometry information
    private let geometryInfo: AWMozaicLayoutSectionGeometryInfo
    ...
    init(geometryInfo: AWMozaicLayoutSectionGeometryInfo) {
    ...
    func frameForItem(withMozaikSize size: AWMozaicLayoutSize, at position: AWMozaicLayoutPosition) -> CGRect {
    ...
    private func xOffsetForItem(at position: AWMozaicLayoutPosition) -> CGFloat {
    ...
    private func yOffsetForItem(at position: AWMozaicLayoutPosition) -> CGFloat {
